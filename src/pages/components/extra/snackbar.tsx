...
DemoSnackbarPage.getLayout = (page: React.ReactElement) => (
...
export default function DemoSnackbarPage() {
  ...
  return (
    <>
      <Head>
        <title> Extra Components: Snackbar | Admin Dashboard</title>
      </Head>
        ...
        <Masonry columns={{ xs: 1, md: 2 }} spacing={3}>
          <Block title="Simple" sx={style}>
            <Button
              ...
              color="inherit"
              onClick={() =>
                enqueueSnackbar('This is an default', { variant: 'default' })
              }
            >
              Default
            </Button>
